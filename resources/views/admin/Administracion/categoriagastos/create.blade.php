<x-admin-layout :breadcrumbs="[
    ...
    <div class="p-6 bg-white rounded-lg shadow w-full">
        <h2 class="text-xl font-bold mb-4 text-black">Nueva Categoría de Gasto</h2>

        <form method="POST" action="{{ route('admin.administrativo.categoriasgastos.store') }}" class="grid gap-4 w-full">
            @csrf
