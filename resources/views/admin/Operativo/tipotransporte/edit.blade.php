<x-admin-layout :breadcrumbs="[
    ...
    ['name' => 'Tipos de Transporte', 'href' => route('admin.operativo.tipotransporte.index')],
    ['name' => 'Editar']
]">
    <div class="p-6 bg-white rounded-lg shadow">
        <h1 class="text-2xl font-semibold mb-4 text-black">Editar Tipo de Transporte</h1>

        <form action="{{ route('admin.operativo.tipotransporte.update', $tipoTransporte->id) }}" method="POST" class="grid gap-4">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" name="nombre_transporte" id="nombre_transporte"
                       value="{{ old('nombre_transporte', $tipoTransporte->nombre_transporte) }}"
            ...
            <div>
                ...
                <textarea name="descripcion_transporte" id="descripcion_transporte"
                          class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">{{ old('descripcion_transporte', $tipoTransporte->descripcion_transporte) }}</textarea>
            </div>
