...
$links = [
    ...
    [
        ...
        'submenu' => [
            ...
            [
                'name' => 'Añadir nueva ruta',
                'icon' => 'fa-solid fa-plus',
                'href' => route('admin.operativo.rutas.create'),
                'active' => request()->routeIs('admin.operativo.rutas.create'),
            ],
        ],
    ],
    [
                                ...
                                @foreach ($link['submenu'] as $item)
                                    <li>
                                        <a href="{{$item['href']}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 {{$item['active'] ? 'bg-gray-100 border-l-2 border-gray-900 rounded-l-none' : ''}}">
                                            <i class="{{$item['icon']}} w-5 h-5 me-2"></i>
                                            {{$item['name']}}
                                        </a>
                                    </li>
                                @endforeach
